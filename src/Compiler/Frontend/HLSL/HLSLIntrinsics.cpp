...
static HLSLIntrinsicsMap GenerateIntrinsicMap()
{
    ...
    return
    {
        ...
        { "asin",                               { T::ASin,                              1, 1 } },
        { "asint",                              { T::AsInt,                             4, 0 } },
        { "asuint",                             { T::AsUInt,                            5, 0 } }, // AsUInt_2: 4.0
        { "atan",                               { T::ATan,                              1, 1 } },
        { "atan2",                              { T::ATan2,                             1, 1 } },
        { "ceil",                               { T::Ceil,                              1, 1 } },
