...
static HLSLIntrinsicsMap GenerateIntrinsicMap()
{
    ...
    return
    {
        ...
        { "CalculateLevelOfDetail",             { T::Texture_CalculateLevelOfDetail,          4, 1 } }, // Fragment shader only
        { "CalculateLevelOfDetailUnclamped",    { T::Texture_CalculateLevelOfDetailUnclamped, 4, 1 } }, // Fragment shader only
...
static std::map<Intrinsic, IntrinsicDescriptor> GenerateIntrinsicDescriptorMap()
{
    ...
    return
    {
      ...
      //{ T::Transpose,                               {  }                    }, // special case
        ...
        { T::Texture_CalculateLevelOfDetail,          { DataType::Float,  2 } },
        { T::Texture_CalculateLevelOfDetailUnclamped, { DataType::Float,  2 } },
