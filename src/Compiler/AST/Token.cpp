...
std::string Token::TypeToString(const Types type)
{
    switch (type)
    {
        ...
        case Types::StringType:         return R_StringType;
        case Types::ScalarType:         return R_ScalarType;
        case Types::VectorType:         return R_VectorType;
        case Types::MatrixType:         return R_MatrixType;
        case Types::Void:               return R_VoidType;
        case Types::PrimitiveType:      return R_PrimitiveType;
        case Types::Reserved:           return R_ReservedWord;
        case Types::Vector:             return R_VectorGenericType;
        case Types::Matrix:             return R_MatrixGenericType;
        case Types::Sampler:            return R_SamplerType;
        case Types::SamplerState:       return R_SamplerState;
        case Types::Buffer:             return R_BufferType;
        case Types::UniformBuffer:      return R_UniformBufferType;
