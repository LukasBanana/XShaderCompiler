...
void MetalGenerator::WriteProgramHeaderComment()
{
    ...
    {
        /* Write header */
        WriteComment("Metal " + ToString(GetShaderTarget()));
...
//TODO
void MetalGenerator::WriteFunctionEntryPoint(FunctionDecl* ast)
{
    ...
    /* Write function header */
    BeginLn();
    WriteFunctionEntryPointType(ast);
    Write(" ");
    Visit(ast->returnType);
    Write(" " + ast->ident + "(");
...
//TODO
void MetalGenerator::WriteFunctionEntryPointType(FunctionDecl* ast)
{
    //TESTING
    Write("vertex");
}
