...
static std::map<Intrinsic, std::string> GenerateIntrinsicMap()
{
    ...
    return
    {
      ...
      //{ T::Texture_SampleLevel_5,                   ""                      },
        { T::Texture_CalculateLevelOfDetail,          "textureQueryLod"       }, // textureQueryLod(...).y  <--  clamped to base level
        { T::Texture_CalculateLevelOfDetailUnclamped, "textureQueryLod"       }, // textureQueryLod(...).x  <--  unclamped
